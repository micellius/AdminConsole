 ...
 */
jQuery.sap.require("tests.adminconsole.apps.UserEditor.utils.Privileges");
jQuery.sap.require("tests.adminconsole.apps.UserEditor.utils.API");
sap.ui.controller("tests.adminconsole.apps.UserEditor.controller.detail.Assignment", {
    ...
    onInit: function() {
        ...
        this.oAppController.oEventBus.subscribe('selectUsers', function () {
            ...
            if(!oController.oOldRouteArguments ||
                ...
                this.oUser = oUser = aUsers[0];
                if(oUser) {
                    oData = {
                        headerTitle: oUser.objectName,
                        headerDesctiption: oUser.roleId
                    };
    ...
    onDeletePress: function() {
        this.oAppController.oEventBus.publish('deleteSelectedUsers');
    },
    ...
    openPopover: function(oItem) {
        var Privileges = tests.adminconsole.apps.UserEditor.utils.Privileges,
        ...
        this._loadDetailedPrivileges(oModel, oData, this.oUser.objectName).done(function() {
            var index,
                aGranted,
                aGrantedPrivileges,
                aRevoked,
    ...
    deleteObject: function(opts) {
        ...
        // Define Aliases
        oController = this;
        Privileges = tests.adminconsole.apps.UserEditor.utils.Privileges;
        // Root view model
        oModel = this.getView().getModel();
        // Key of selected tab
        sType = this.getView().oIconTabBar.getSelectedKey();
        ...
        for(i=0, l=aSelectedItems.length; i<l; i++) {
            ...
            if(Privileges.getDefaultPrivilegesByObjectType(oPrivilege.objectType).length === 0) {
                ...
                this._getDetailedPrivileges(oPrivilege, this.oUser.objectName, function(data) {
                    var oPrivilege, i, l;
    ...
    _loadDetailedPrivileges: function(oTargetModel, oData, sUserName) {
        var oModel,
            oDeferred,
            API = tests.adminconsole.apps.UserEditor.utils.API;
    ...
    _getDetailedPrivileges: function(oData, sUserName, callback) {
